...
export const LEGACY_CUSTOMER_TYPES = {
  ...
  retail_client: 'end_client',
  retail:       'end_client',
  retail_b2c:   'end_client',
  b2c:          'end_client',
  b2c_buyer:    'end_client',
  b2c_existing: 'end_client',
  repeat_b2c:   'end_client',
  individual:   'end_client',
  client:       'end_client',
  lead:         'end_client',
  private:      'unknown',
  existing_customer: 'end_client',
  designer:     'partner',      // Omoikiri: дизайнеры = партнёры
  designer_partner: 'partner',
  designer_repeat: 'partner',
  designer_or_b2b: 'partner',
  client_or_designer: 'partner',
  b2b_designer: 'partner',
  b2b_partner:  'partner',
  b2b_dealer:   'partner',
  b2b:          'partner',
  ...
  internal:     'colleague',
  internal_team: 'colleague',
  internal_group: 'colleague',
