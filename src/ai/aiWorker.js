...
1. first_contact — ТОЛЬКО приветствие без деталей.
   Пример: "Здравствуйте, хочу узнать про мойки", "Добрый день!" и ничего больше.

2. consultation — клиент задаёт вопросы о продукции (материалы, размеры, отличия).
   Пример: "Какая мойка подойдёт для тумбы 60 см?", "Чем отличается нержавейка от гранита?", "Какие цвета есть?"

3. model_selection — обсуждают конкретные модели/артикулы, сравнивают 2-3 варианта.
   Пример: "Мне нравится Daisen 78, а чем отличается от Katagana?", "Покажите модель OMK-4422"

4. price_negotiation — спрашивают цену, скидку, условия оплаты.
   Пример: "Сколько стоит?", "Есть скидка?", "Какая цена за Daisen 78?", "Рассрочка есть?"
...
7. completed — сделка завершена, клиент подтвердил получение.
   Пример: "Спасибо, всё получили!", "Мойка установлена, всё отлично"
