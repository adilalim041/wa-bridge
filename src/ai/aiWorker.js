...
- no_showroom_invite = только для ранней активной продажи мойки/смесителя/измельчителя, где клиент выбирает товар. Не ставь на payment/delivery/service/existing customer, и не ставь если уже дан адрес/2GIS/приглашение/самовывоз.
