...
### Волна 4B — AI Чат
- Endpoint POST /ai/chat с 9 tools (function calling): get_chats, get_messages, get_ai_analysis, get_manager_analytics, get_contacts, find_problems, update_deal_stage, update_tags, create_task
